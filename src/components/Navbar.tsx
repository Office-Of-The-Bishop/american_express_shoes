...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full bg-[#F6EDDA] border-b border-[#e8d9c3] z-50 h-[13%]">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="items-center h-[30%] gap-3">
          <img src={logo} alt="American Shoe Express" className="h-[120%] w-[120%] sm:h-10" />
